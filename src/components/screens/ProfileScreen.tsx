...
export default function ProfileScreen() {
  ...
  return (
    <div className="pt-8 lg:pt-14">
      ...
      <div className="mt-8 space-y-7">
        <div>
          ...
          <input
            ...
            className="w-full max-w-sm rounded-2xl border border-line bg-surface px-4 py-3 text-[15px] shadow-soft outline-none transition-colors focus:border-ink/40"
          />
        </div>
          ...
          <div className="flex flex-wrap gap-2">
            {DIETS.map((d) => (
              <button
                ...
                className={optionButton(prefs.diet === d.id)}
              >
                {d.label}
              </button>
            ))}
          ...
          <div className="flex flex-wrap gap-2">
            {SKILLS.map((s) => (
              <button
                ...
                aria-pressed={prefs.skill === s.id}
                className={optionButton(prefs.skill === s.id)}
              >
                {s.label}
              </button>
            ))}
          ...
          <div className="flex flex-wrap gap-2">
            {GOALS.map((g) => (
              <button
                ...
                aria-pressed={prefs.fitnessGoal === g.id}
                className={optionButton(prefs.fitnessGoal === g.id)}
              >
                {g.label}
              </button>
            ))}
            ...
            <div className="flex gap-2">
              {([1, 2, 3, 4] as People[]).map((p) => (
                <button
                  ...
                  aria-pressed={prefs.defaultServings === p}
        ...
        <div className="mt-9">
          ...
          <Card className="p-5 sm:p-6">
            ...
            <div className="mt-3 flex flex-wrap gap-2">
              {FEEDBACK_TOPICS.map((t) => (
                <button
                  ...
                  aria-pressed={feedbackTopic === t.id}
            ...
            <textarea
              ...
              className="mt-3 w-full resize-none rounded-2xl border border-line bg-surface p-3.5 text-[14px] leading-relaxed shadow-soft outline-none transition-colors focus:border-ink/50"
            />
      ...
      <p className="mb-4 mt-9 text-center text-[12px] leading-relaxed text-muted">
